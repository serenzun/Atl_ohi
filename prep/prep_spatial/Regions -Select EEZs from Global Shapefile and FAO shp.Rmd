...
regions_gl <- st_read("~/big/atl_regions/Regions_atl_FAO.shp", quiet = TRUE)
...
lng_gl<-st_read("~/big/Longhurst_world_v4_2010/mapshaper_90/Longhurst_world_v4_2010.shp",quiet=TRUE)#I have simplified the geometry through the mapshaper.org. The problem lies in sme polygons of the baltic sea. 
...
plot(lng_gl_sp)
head(lng_gl_sp)
lng_atl_cr<-raster::crop(lng_gl_sp,reg_atl_FAO_sp)
plot(lng_atl_cr)
head(lng_atl_cr)
lng_atl_mk<-raster::mask(lng_atl_cr,reg_atl_FAO_sp)
