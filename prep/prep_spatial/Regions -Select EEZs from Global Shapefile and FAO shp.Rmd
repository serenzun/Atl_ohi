...
sf::write_sf(regions_atl_FAO,  "Regions_atl_FAO.shp")#if you want to re-run, delete the file in the folder
```
...
Istruzioni da qui:https://ohi-science.org/news/cropping-rasters-down-to-size

bottom_t<-raster(file.path)
=======
---
title: "Regions -Select EEZs from Global Shapefile and FAO shp"
output: html_document
...
```{r}
here()
source(here::here('~/github/ohi-plus-template/big2'))
shp_atl <- file.path("FAO_atl_MAJOR.shp")
...
bottom_t<-raster(file.path)
>>>>>>> 29d529a57c550d3185ccfdfeae4403508d8e2c87
