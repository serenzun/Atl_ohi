...
w_ref=quantile(w_log, prob=c(0.9999))
w_99 = w_ref[10]
c_99 = c_ref[10]
...
```{r rescale, message=F,warning=F}
 w_rescale = calc(w_log,fun=function(x){ifelse(x>w_99,1,x/w_99)},filename=file.path(data_wd,'output/weight_rescale.tif'),overwrite=T)
